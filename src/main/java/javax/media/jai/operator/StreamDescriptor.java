 ...
 * registered with the <code>ImageCodec</code>
 * class.
 *
 * <p> The allowable formats are those registered with the
 * <code>ImageCodec</code> class.
 *
 ...
 * <tr><td>stream</td>        <td>SeekableStream</td>
 *                            <td>NO_PARAMETER_DEFAULT</td>
 * <tr><td>param</td>         <td>ImageDecodeParam</td>
 *                            <td>null</td>
 * </table></p>
 *
...
public class StreamDescriptor extends OperationDescriptorImpl {
    ...
    private static final Class[] paramClasses = {
        SeekableStream.class,
        ImageDecodeParam.class
    };
