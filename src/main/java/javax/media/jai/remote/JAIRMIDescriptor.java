 ...
 *
 * <pre>
 * java -Djava.rmi.server.codebase="file:$JAI/lib/jai_core.jar file:$JAI/lib/jai_codec.jar" -Djava.rmi.server.useCodebaseOnly=false -Djava.security.policy=file:$JAI/policy JAIRMIImageServer
 * </pre>
 *
 ...
 * <code>JAIServerConfigurationSpi</code> interface
 * on the <code>CLASSPATH</code> when starting the server.
 * For more details, please refer to
 * {@link JAIServerConfigurationSpi}
 *
