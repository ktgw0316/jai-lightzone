...
public class SubsampleAverageOpImage extends GeometricOpImage {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        RenderedImage diff = JAI.create("subtract",
                                   JAI.create("format", dest,
                                                              DataBuffer.TYPE_SHORT),
                                   JAI.create("format", destML,
                                                              DataBuffer.TYPE_SHORT));
        RenderedImage absDiff = JAI.create("absolute", diff);
        double[] maxima =
            (double[])JAI.create("extrema", absDiff).getProperty("maximum");
        ...
        ScrollingImagePanel ps =
            new ScrollingImagePanel(dest,
                                                           512, 512);
        ScrollingImagePanel pd =
            new ScrollingImagePanel(destML,
                                                           512, 512);
        frame.add(ps);
        frame.add(pd);
        frame.pack();
